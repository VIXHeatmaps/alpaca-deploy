                            ...
                            <table style={{
                              ...
                              <thead>
                                <tr style={{ background: '#f9fafb', borderBottom: '2px solid #d1d5db' }}>
                                  <th style={{ padding: '6px 8px', textAlign: 'left', fontWeight: '600', position: 'sticky', top: 0, background: '#f9fafb', zIndex: 1, whiteSpace: 'nowrap' }}>
                                    DATE
                                  </th>
                                  {tickers.map((ticker) => (
                                    <th key={ticker} style={{ padding: '6px 8px', textAlign: 'left', fontWeight: '600', position: 'sticky', top: 0, background: '#f9fafb', zIndex: 1, whiteSpace: 'nowrap' }}>
                                      {ticker}
                                    </th>
                                  ))}
                                  {gates.map((gate) => (
                                    <th key={gate} style={{ padding: '6px 8px', textAlign: 'left', fontWeight: '600', position: 'sticky', top: 0, background: '#f9fafb', zIndex: 1, whiteSpace: 'nowrap' }} title={gate}>
                                      {gate.slice(0, 5)}
                                    </th>
                                  ))}
                                </tr>
